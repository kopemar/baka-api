...
class SpecializedPreferredTest < ActionDispatch::IntegrationTest
  ...
  test "Specialized Preferred Improve" do
    ...
    violations_hash_1 = Scheduling::DemandFulfill.get_violations_hash(ShiftTemplate::in_scheduling_period(period.id), schedule)
    ...
    violations_hash_2 = Scheduling::DemandFulfill.get_violations_hash(ShiftTemplate::in_scheduling_period(period.id), schedule)
